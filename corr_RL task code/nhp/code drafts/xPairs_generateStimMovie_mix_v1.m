function [movieFrames] = xPairs_generateStimMovie_mix_v1(TrialRecord)
...
% --- RETRIEVE STIM PAIR1 IMGFILES AND XY
stimPair1_noise1_fn = TrialRecord.User.condArray(c).stimPairs(1).noise1_fn;
stimPair1_noise1_x = TrialRecord.User.condArray(c).stimPairs(1).noise1.x;
stimPair1_noise1_y = TrialRecord.User.condArray(c).stimPairs(1).noise1.y;
stimPair1_noise2_fn = TrialRecord.User.condArray(c).stimPairs(1).noise2_fn;
stimPair1_noise2_x = TrialRecord.User.condArray(c).stimPairs(1).noise2.x;
stimPair1_noise2_y = TrialRecord.User.condArray(c).stimPairs(1).noise2.y;

% --- RETRIEVE STIM PAIR2 IMGFILES AND XY 
stimPair2_noise1_fn = TrialRecord.User.condArray(c).stimPairs(2).noise1_fn;
stimPair2_noise1_x = TrialRecord.User.condArray(c).stimPairs(2).noise1.x;
stimPair2_noise1_y = TrialRecord.User.condArray(c).stimPairs(2).noise1.y;
stimPair2_noise2_fn = TrialRecord.User.condArray(c).stimPairs(2).noise2_fn;
stimPair2_noise2_x = TrialRecord.User.condArray(c).stimPairs(2).noise2.x;
stimPair2_noise2_y = TrialRecord.User.condArray(c).stimPairs(2).noise2.y;

% --- RETRIEVE STIM PAIR3 IMGFILES AND XY
stimPair3_noise1_fn = TrialRecord.User.condArray(c).stimPairs(3).noise1_fn;
stimPair3_noise1_x = TrialRecord.User.condArray(c).stimPairs(3).noise1.x;
stimPair3_noise1_y = TrialRecord.User.condArray(c).stimPairs(3).noise1.y;
stimPair3_noise2_fn = TrialRecord.User.condArray(c).stimPairs(3).noise2_fn;
stimPair3_noise2_x = TrialRecord.User.condArray(c).stimPairs(3).noise2.x;
stimPair3_noise2_y = TrialRecord.User.condArray(c).stimPairs(3).noise2.y;

% --- RETRIEVE STIM PAIR4 IMGFILES AND XY
stimPair4_noise1_fn = TrialRecord.User.condArray(c).stimPairs(4).noise1_fn;
stimPair4_noise1_x = TrialRecord.User.condArray(c).stimPairs(4).noise1.x;
stimPair4_noise1_y = TrialRecord.User.condArray(c).stimPairs(4).noise1.y;
stimPair4_noise2_fn = TrialRecord.User.condArray(c).stimPairs(4).noise2_fn;
stimPair4_noise2_x = TrialRecord.User.condArray(c).stimPairs(4).noise2.x;
stimPair4_noise2_y = TrialRecord.User.condArray(c).stimPairs(4).noise2.y;
