function LLH = compute_llh_RescorlaWagner_corr_RL_corr_int_plus_repnum(params, choice, rew, block, corr, repnum)
    alpha = params(1);
    beta = params(2);
    a_interaction = params(3);
    b_interaction_corr = params(4);  
    b_interaction_rep = params(5);  
    ...
    for t = 1:ntrials
        ...
        newtemp = max(0.01, beta + b_interaction_corr*corr(t) + b_interaction_rep*repnum(t));  % Ensure positive temperature
