...
% Each movie is a series of 'samples',
% which are parametrically incremental mixtures of the base curve (circle)
% and varying weights of 'endcurve'.  Weighting is controlled by 't'
% paramter that scales from -1 to +1. 
