...
preMovie_img = {[], [], times.sc3_preMovie_frames, codes.sc3_movFr_preMovie};
soa_img = {[], [], times.sc3_soa_frames, codes.sc3_movFr_soa};
interPair_img = {[], [], times.sc3_interPair_frames, codes.sc3_movFr_interPair};
...
for p = 1 : length(pairs)
    ...
    pair_img = {{leftImg_fn, rightImg_fn}, [leftImg_x leftImg_y; rightImg_x rightImg_y], times.sc3_stim_frames, codes.sc3_movFr_pairOn};
    leftImg_frame = {{leftImg_fn}, [leftImg_x leftImg_y], times.sc3_stim_frames, codes.sc3_movFr_leftOn};
    rightImg_frame = {{rightImg_fn}, [rightImg_x rightImg_y], times.sc3_stim_frames, codes.sc3_movFr_rightOn};
    blankImg_frame = {[], [], times.sc3_stim_frames, codes.sc3_movFr_singletonOff};
