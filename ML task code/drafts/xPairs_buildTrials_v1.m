...
function [condArray, condReps, stimArray, params] = xPairs_buildTrials_v1()
...
% stimulus timing
params.preStimDur = 60;  % 60 frames is 0.5 seconds at 120 Hz
params.stimDur = 4;
params.soa = 3;
...
for b = 1 : params.numBlocks
    ...
    [stimPairs, noisePairs] = xPairs_buildStimPairs(params);
    ...
    for c = 1:2 % choice config, randomize choice image location to implement
        ...
        for p = 1 : params.pairsPerBlock
            ...
            % --- stimulus feature/location parameters
            ...
            condArrayTemp(b, c, p).preStimDur = params.preStimDur;
            ...
            condArrayTemp(b, c, p).movieMode = 'simultaneous';
