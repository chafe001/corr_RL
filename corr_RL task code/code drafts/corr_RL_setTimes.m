...
switch COMPUTER
    ...
    case 'MATT_MICRO'
        ...
        times.interPair_frames = 20; % 100 ms
...
case 'LAPTOP-42DLT8TH'
    ...
    case '3080Y25-G0Y3FF' % augsburg desktop 60 Hz (double frames from 120 hz)
        ...
        times.sc1_pretrial_ms = 20; % DCNEW: don't change these ms values based on refresh rate?
        times.sc3_response_ms = 2500;
