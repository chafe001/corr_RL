function [movieFrames, pairSeq] = xPairs_generateStimMovie_mix_v4(TrialRecord)
...
% variables from buildTrials to work with
% condArrayTemp(b, c, m).falsePairProportion
% params.corrStrength_mode = 'pairMix' or 'noiseMix'

% --- compute number of false and true stimulus pairs
numFalse = floor(params.moviePairReps * condArray(c).falsePairProportion);
numTrue= params.moviePairReps - numFalse;
